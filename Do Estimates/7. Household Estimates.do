...
* Removing observations in which head of household is outside of the proxy for lifetime income:
...
* Remove observations if head of household is older than max parent age at child birth (34):
