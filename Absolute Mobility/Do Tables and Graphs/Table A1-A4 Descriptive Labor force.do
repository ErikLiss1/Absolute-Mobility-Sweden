...
save "Table A1 Descriptive Table Labour Force ParentChildKind $ParentChildKind", replace

export excel "Table A1 & A3 Descriptive Table Labour Force ParentChildKind $ParentChildKind", firstrow(varlabels) replace
...
cd "$user_main\Absolute Mobility\Output Main Tables And Figure"
save "Table A2 Descriptive Table Labour Force ParentChildKind $ParentChildKind", replace

export excel "Table A2 A4 Descriptive Table Labour Force ParentChildKind $ParentChildKind", firstrow(varlabels) replace
