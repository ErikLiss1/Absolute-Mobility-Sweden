...
graph export "Decomposition Men Emprical Parent.png", as(png) replace
graph export "Decomposition Men Empirical Parent.pdf", as(pdf) replace
...
cd "$user_main\Absolute Mobility\Output Main Tables And Figure"
graph export "Decomposition Women Empirical Parent.png", as(png) replace
graph export "Decomposition Women Empirical Parent.pdf", as(pdf) replace
