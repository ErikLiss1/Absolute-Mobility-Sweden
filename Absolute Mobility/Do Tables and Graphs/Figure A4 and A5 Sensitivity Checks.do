...
graph export "Figure A4 Robustness Check Men.png", as(png) replace
graph export "Figure A4 Robustness Check Men.pdf", as(pdf) replace
graph export "Figure A4 Robustness Check Men.tif", as(pdf) replace
...
cd "$user_main\Absolute Mobility\Output Main Tables And Figure"
graph export "Figure A5 Robustness Check Women.png", as(png) replace
graph export "Figure A5 Robustness Check Women.pdf", as(pdf) replace
graph export "Figure A5 Robustness Check Women.tif", as(pdf) replace
