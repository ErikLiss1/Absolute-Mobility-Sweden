...
In this dataset we estimate absolute mobility assuming employees bear the whole
...
income data for when the parent is 30 years of age. The first cohort we 
therefore can estimate absolute mobility for is then determined 
by the parent with the highest age at child birth is at least
