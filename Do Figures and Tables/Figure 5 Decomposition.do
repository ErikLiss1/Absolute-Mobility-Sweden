...
graph export "Decomposition Men.png", as(png) replace
graph export "Decomposition Men.pdf", as(pdf) replace
...
cd "$user_main\Absolute Mobility\Output Main Tables And Figure"
graph export "Decomposition Women.png", as(png) replace
graph export "Decomposition Women.pdf", as(pdf) replace
