...
*graph export "Decomposition Women Single Year.png", as(png) replace
*graph export "Decomposition Women Single Year.pdf", as(pdf) replace
...
grc1leg SingleYear MultiYear, graphregion(fcolor(white))

cd "$user_main\Absolute Mobility\Output Main Tables And Figure"
graph export "Figure A3 Single Year Decompositions Women.png", replace
graph export "Figure A3 Single Year Decompositions Women.pdf", replace
graph export "Figure A3 Single Year Decompositions Women.tif", replace

* Open next do-file:

cd "$user_main\Absolute Mobility\Do Tables and Graphs"
doedit "Figure A4 and A5 Sensitivity Checks.do"
